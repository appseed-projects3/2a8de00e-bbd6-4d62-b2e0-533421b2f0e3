...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2023-11-20 09:54`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/2a8de00e-bbd6-4d62-b2e0-533421b2f0e3.git
$ cd 2a8de00e-bbd6-4d62-b2e0-533421b2f0e3
```
